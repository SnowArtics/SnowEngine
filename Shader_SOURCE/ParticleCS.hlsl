...
{    
    ...
    if (ParticleBuffer[DTid.x].active == 0)
    {
        ...
        if (ParticleBuffer[DTid.x].active == 1)
        {
            ...
            ParticleBuffer[DTid.x].direction.xyz = vRandom.xyz * 1.f;
            //ParticleBuffer[DTid.x].position.x -= 1.5f;
            //ParticleBuffer[DTid.x].position.y -= 1.5f;
            ParticleBuffer[DTid.x].position.z = 0.0f;
            
            ParticleBuffer[DTid.x].speed = vRandom.xyz * 3.0f;
        }
    }
    else
    {
        ...
        if (ParticleBuffer[DTid.x].time > vRandom.x+1.0f)
        {
