...
namespace sn::math
{
	...
	const Vector4 sn::math::Vector4::Zero = { 0.f, 0.f, 0.f, 0.f };
...
//	RECT Viewport::ComputeDisplasnrea(DXGI_SCALING scaling, UINT backBufferWidth, UINT backBufferHeight, int outputWidth, int outputHeight) noexcept
//	{
//		RECT rct = {};
//
//		switch (int(scaling))
