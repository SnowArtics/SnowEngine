...
void GolemTurret::OnCollisionEnter(sn::Collider2D* other, sn::Collider2D* me)
{
...
void GolemTurret::OnCollisionStay(sn::Collider2D* other, sn::Collider2D* me)
{
}

void GolemTurret::OnCollisionExit(sn::Collider2D* other, sn::Collider2D* me)
{
}
